...
def contruction_grille(imax,L): #Permet de créer la grille initiale du jeu en utilisant des tirets et des barres verticales pour une lisibilité plus optimale
...
def jouer(grille,x,y,imax,taille_reel_grille,L): #permet de mettre le symbole à l'emplacement choisi par le joueur si ce dernier est vide
